...
# --- Configurazione Path ---
# Aggiungiamo la directory principale del progetto al sys.path
# e configuriamo il path delle DLL OpenSSL su Windows
try:
    project_root = Path(__file__).parent.parent
    sys.path.insert(0, str(project_root))

    # Su Windows, aggiungiamo il path delle DLL OpenSSL
