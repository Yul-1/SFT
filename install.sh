...
if [ -d "$PROJECT_DIR" ]; then
    ...
    if [ "$REPO_URL" == "https://github.com/TUO_UTENTE/TUO_REPOSITORY.git" ]; then
...
# --- Variabili ---
# !!! IMPORTANTE: Sostituisci con l'URL del tuo repository GitHub
REPO_URL="https://github.com/TUO_UTENTE/TUO_REPOSITORY.git"
PROJECT_DIR="AegisTransfer" # La cartella dove verrà clonato il repo
PYTHON_CMD="python3"
VENV_DIR="venv"
